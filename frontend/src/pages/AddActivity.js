                ...
                <div className="form-row">
                  <div className="form-group">
                    <label htmlFor="start_date" className="form-label">
                      <span className="label-text">Start Date <span className="label-required">*</span></span>
                  ...
                  <div className="form-group">
                    <label htmlFor="start_time" className="form-label">
                      <span className="label-text">Start Time <span className="label-required">*</span></span>
